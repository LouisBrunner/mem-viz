...
func (me *parser) addCache(parent *contracts.MemoryBlock, cache subcontracts.Cache, label string, offset subcontracts.Address, imgsBlocks []*contracts.MemoryBlock) (*contracts.MemoryBlock, *contracts.MemoryBlock, []*contracts.MemoryBlock, error) {
	...
	_, imgsBlocks, err = me.parseImages(frame, imgs, pathsBlock, imgsBlocks)
	if err != nil {
		return nil, nil, nil, err
	}
	if okV2 {
